...
export default function TaskArchiveButton({ taskId }: { taskId: string }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm">
            <div className="px-6 py-4 border-b border-stone-200">
              <h2 className="font-semibold text-stone-900">Aufgabe archivieren</h2>
            </div>
            <div className="px-6 py-5">
              <p className="text-sm text-stone-600">
                Die Aufgabe wird ins Archiv verschoben und erscheint nicht mehr in der Hauptliste. Sie kann jederzeit wiederhergestellt werden.
              </p>
            </div>
