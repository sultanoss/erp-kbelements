...
<div class="box">
  ...
  <p class="step">Trage diesen Refresh Token als <strong>EBAY_OUTLET_REFRESH_TOKEN</strong> in Vercel ein:</p>
  ...
  <p class="step">2. EBAY_OUTLET_REFRESH_TOKEN = Wert oben</p>
